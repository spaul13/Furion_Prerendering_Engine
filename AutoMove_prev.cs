...
public class AutoMove_prev : MonoBehaviour
{
    ...
    IEnumerator TraverseRect()
    {
        ...
        while (!currentPoint.Equals(endPoint))
        {
            ...
            Debug.Log("[" + loopNum + ", " + m_Rigidbody.position.x + ", " + m_Rigidbody.position.z + "]\n");
            File.AppendAllText(fp + "logexp_panoramicindexing_050119.txt", "[" + loopNum + "," + m_Rigidbody.position.x + "," + m_Rigidbody.position.z + "]\n");
